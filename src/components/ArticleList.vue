<template>
  <div>
    ...
    <div v-else>
      ...
      />
      <MyPagination :pages="pages" :currentPage.sync="currentPage"/>
    </div>
  </div>
</template>
...
import { FETCH_ARTICLES } from "../common/constants";
...
export default {
  ...
  computed: {
    ...mapGetters(["articlesCount", "isLoading", "articles", "currentUser"]),
    listConfig() {
      const { type } = this;
      const filters = {
